...
uproductlinks = []
productInfo = []
for x in tqdm(range(0,959)):
    if x % 10 == 0:
        time.sleep(6)
    r = requests.get(f'https://www.olx.co.id/bali_g2000002/tanah_c4827?page={x}',  #mengambil 20 item per halaman
        headers=headers)
...
df.to_csv('jualTanahl20210220.csv')